  ...
  pay: function() {
    ...
    DataStore.deployed().then(function(instance) {
      ...
      setTimeout(function(){
        ...
        return ds.SendPaymentToUbi({from: account, value: web3.toWei(self.amount.price, 'ether')}).then(function (){console.log("transferred from contract to ubi")}).catch(function(e){console.log(e);console.log("cannnot transfer from contract to ubi")})
